...
//        Verify that the insertion worked
        ...
        assertTrue("Error: no records returned from loc query", c.moveToFirst());
        ...
        assertFalse("More than one record returned while we only inserted one record", c.moveToNext());
